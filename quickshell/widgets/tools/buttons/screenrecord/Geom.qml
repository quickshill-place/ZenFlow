...
PanelWindow {
    ...
    MouseArea {
        ...
        onReleased : (mouse) => {
            ...
            const geometry = `${geomRect.anchor1X}x${geomRect.anchor1Y}+${geomRect.anchorDx}+${geomRect.anchorDy}`
            myCommand.command = ["gpu-screen-recorder", "-w", "region", "-region", geometry, "-o", "/home/zenflow/Videos/video.mp4"]
            myCommand.text = geometry
            myCommand.running = true // ✅ this is the key
        }
